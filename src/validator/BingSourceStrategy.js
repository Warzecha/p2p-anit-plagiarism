...
const getSearchUrl = (keyword) => `https://api.cognitive.microsoft.com/bingcustomsearch/v7.0/search?q=${keyword}&customconfig=60e9d352-3ed0-4af1-92cc-03f665324ea3&mkt=pl-PL`;
